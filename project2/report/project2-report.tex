...
to class $1$, given $\mathbf{x}^{(i)}$. The \textit{logistic model} is 
\begin{align}
 \text{Pr} \left(y=1 | \mathbf{x}; \beta \right) &= \frac{1}{1+e^{-\beta \cdot \mathbf{x}}} \\
 \text{Pr} \left(y=0 | \mathbf{x}; \beta \right) &= 1 - \text{Pr} \left(y=1 | \mathbf{x}; \beta \right).
\end{align}
...
\begin{equation}
 \hat{y}_i = \begin{cases}
            1 \ \ \text{if }  \text{Pr} \left(y=1 | \mathbf{x}^{(i)} \right) \geq 0.5 \\
            0 \ \ \text{if }  \text{Pr} \left(y=1 | \mathbf{x}^{(i)} \right) < 0.5. \\
           \end{cases}
\end{equation}
