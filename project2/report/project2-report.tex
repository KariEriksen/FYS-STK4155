...
form $\text{sym}(A) = \text{sym}(J) + D$ with $\text{Tr}(D) = 0$, result in the same energies as $J$ itself.
...
explained by showing that there is a whole class of matrices on the form $\text{sym}(A) = \text{sym}(J) + D$ with $\text{Tr}(D) = 0$ 
