...
A final run with a longer training time for the $\lambda=10^{-3}$ yields the best performance in the present work at $96.8\%$ accuracy for the critical samples. This final network is marked $\ddag$ in \tab{nn_2d}.
