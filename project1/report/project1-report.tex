...
\newlength{\myrowskip}
\setlength{\myrowskip}{20pt}
\begin{table*}
\caption[position=top]{Parameters $\beta$ and their bootstrap computed variance $\sigma^2(\beta)$ for the OLS fits of the Franke function, shown in \fig{3}. \label{tab:1}}
\begin{tabularx}{\textwidth}{lXXXXXXXr}
\
          & $p=2$   &                   & $p=3$   &                   & $p=4$   &                   & $p=5$   &                    \\
          & $\beta$ & $\sigma^2(\beta)$ & $\beta$ & $\sigma^2(\beta)$ & $\beta$ & $\sigma^2(\beta)$ & $\beta$ & $\sigma^2(\beta)$  \\
\hline
